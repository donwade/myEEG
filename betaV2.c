...
float betaV2_coefficients[20] = 
{
// Scaled for floating point

    0.5298850480396883, 1.0597700960793766, 0.5298850480396883, 1.1335767654058426, -0.5523968888231351,// b0, b1, b2, a1, a2
    1, -2, 1, 1.4319763362903395, -0.6521997976505021,// b0, b1, b2, a1, a2
    0.125, 0.25, 0.125, 1.0710684343229848, -0.7698993815082337,// b0, b1, b2, a1, a2
    0.5, -1, 0.5, 1.7129171220033625, -0.8753324566625211// b0, b1, b2, a1, a2
...
{
    betaV2Type *result = (betaV2Type *)malloc( sizeof( betaV2Type ) ); // Allocate memory for the object
    betaV2_init( result );                                               // Initialize it
...
{
    betaV2_executionState executionState;          // The executionState structure holds call data, minimizing stack reads and writes 
    ...
    executionState.pCoefficients = betaV2_coefficients;    // Each call to filterBiquad() will advance pState and pCoefficients to the next biquad
    ...
    betaV2_filterBiquad( &executionState );		// Run biquad #0
    executionState.pInput = executionState.pOutput;         // The remaining biquads will now re-use the same output buffer.

    betaV2_filterBiquad( &executionState );		// Run biquad #1

    betaV2_filterBiquad( &executionState );		// Run biquad #2

    betaV2_filterBiquad( &executionState );		// Run biquad #3
